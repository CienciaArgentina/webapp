...
export default class EditPersonalData extends React.Component {
	...
	render() {
		return (
			<form id='formEditCareer' className='profileForm' onSubmit={this.handleSubmit}>
				<div id="formEditCareer" className="formBody">
									...
									<div key={k} className="__study">
										...
										<div className="pl-4 inputsHalf mt-4">
											...
											<Input
												label="Hasta"
												name='dateTo'
												helperText={o.state!='finalizado'?"Si no finalizaste, podés ingresar una fecha tentativa":false}
												required={o.state=='finalizado'}
												formatInput={
													{date: true, datePattern: ['m', 'Y']}
												}
												validation={
					...
					<button className="bn--green mt-5" type='submit'>
						Guardar
					</button>
				</div>
			</form>
